define({ "api": [
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "http://127.0.0.1:8888/api/assets/select/1",
        "type": "js"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:8888/api/assets/select/:id"
      }
    ]
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "http://127.0.0.1:8888/api/assets/select-all",
        "type": "js"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:8888/api/assets/select-all"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "http://127.0.0.1:8888/api/playlists/insert-content",
        "type": "js"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "http://127.0.0.1:8888/api/playlists/update-playlist-item",
        "type": "js"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:8888/api/playlists/update-playlist-item"
      }
    ]
  }
] });
